...
This file was copied from fablesfable/nflvalue/report.py during the initial
...
left silently broken. If a game-line report renderer is needed later, write a new one against build_ratings.py/backtest.py/montecarlo.py output — do not resurrect this file's prop-shortlist rendering logic.

Original, working version: nfl-sim/fablesfable/nflvalue/report.py (still lives there,
untouched).
"""
